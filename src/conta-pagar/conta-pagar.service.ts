...
export class ContaPagarService {
  ...
  async create(
    ...
    try {
      const { despesaId, quantidadeParcelas, dataVencimento, statusPagamento } =
  ...
  async findByDespesaId(despesaId: number): Promise<ContaAPagar[]> {
    try {
      ...
      console.error('Erro ao buscar contas a pagar por despesa:', error);
      throw error;
    }
  }
